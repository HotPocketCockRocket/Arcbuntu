        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">Root@thearctic.gov</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            case "cd":
                ...
                result = "<p> ah ah ah, you didn't say the magic word.</p> <br><img class=' w-2/5' src='./images/memes/nedry.gif' /><audio id="magic-word" preload="true" src="./images/memes/magicword.mp3" loop="loop"></audio><script>window.onload = function() {
    document.getElementById("magic-word").play()</script>;
}";
                    break;
                }
            ...
            case "mdt":
                if (words[0] === "." || words.length === 0) {
                    ...
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, mdt, spotify, chrome, about-dad, todoist, trash, settings ]";
                }
                break;
            case "echo":
